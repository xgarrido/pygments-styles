...
class UPSUDStyle(Style):
    ...
    styles = {
        ...
        Name.Constant:          "#6E9320"            , # class: 'no' - to be revised
        Name.Decorator:         ""                   , # class: 'nd' - to be revised
        Name.Entity:            ""                   , # class: 'ni'
        Name.Exception:         ""                   , # class: 'ne'
        Name.Function:          "#6E9320"            , # class: 'nf'
